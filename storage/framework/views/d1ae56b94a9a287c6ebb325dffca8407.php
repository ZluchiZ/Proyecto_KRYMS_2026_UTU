...
<body class="internal-page location-page">
    ...
    <main class="location-page-main">
        <a class="location-back-link" href="<?php echo e(route('home')); ?>">← Volver al inicio</a>
        <section class="location-page-card">
            ...
            <form method="POST" action="<?php echo e(route('cliente.location.update')); ?>" class="location-page-form">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PATCH'); ?>
                <label for="direccion-entrega">Dirección de entrega</label>
                <input type="text" name="direccion" id="direccion-entrega" value="<?php echo e($direccionEntrega); ?>" maxlength="500" placeholder="Calle, número y ciudad" required>
                ...
                <input type="hidden" name="latitud" id="location-page-latitud" value="<?php echo e($latitudUsuario); ?>">
                <input type="hidden" name="longitud" id="location-page-longitud" value="<?php echo e($longitudUsuario); ?>">
...
</html><?php /**PATH /opt/lampp/htdocs/Proyecto_KRYMS_2026_UTU/resources/views/Cliente/Ubicacion.blade.php ENDPATH**/ ?>