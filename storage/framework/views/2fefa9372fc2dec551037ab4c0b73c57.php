...
<form method="POST" action="<?php echo e(route('local.store')); ?>">
  ...
  <?php endif; ?>
    ...
    <input type="text" id="cedula_dueno" name="cedula_dueno" inputmode="numeric" maxlength="20" placeholder="Cédula del dueño" value="<?php echo e(old('cedula_dueno')); ?>" required>
